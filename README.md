...
| **Escaneo de Red con Nmap** | Descubrimiento de hosts y servicios en la red local, análisis de resultados y documentación. |progresando|
...
- ISO de Ubuntu Server 22.04 LTS (u otro SO de laboratorio)  
- Conocimientos básicos de Linux y línea de comandos  
- Git para clonar y versionar proyectos  
- Opcional: Kali Linux para simulaciones de ataques  
